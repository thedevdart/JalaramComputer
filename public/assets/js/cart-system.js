...
const DEFAULT_HERO_SLIDES = {
  ...
  slides: [
    ...
    { id: 'networking_support', title: 'Networking Support', subtitle: 'Enterprise LAN, fiber links & structured cabling for offices', image: '/assets/images/hero/networking_support.jpg', imageMobile: '/assets/images/hero/networking_support_mobile.jpg', cta: 'Network Solutions', link: '/services', align: 'left', order: 1 },
    { id: 'printers_repair', title: 'Printers Repair', subtitle: 'Printer sales, toner supply & on-site repair for businesses', image: '/assets/images/hero/printers_repair.jpg', imageMobile: '/assets/images/hero/printers_repair_mobile.jpg', cta: 'Printer Services', link: '/services', align: 'right', order: 2 },
    { id: 'computer_repair', title: 'Computer Repair', subtitle: 'Desktop diagnostics, upgrades & preventive maintenance', image: '/assets/images/hero/computer_repair.jpg', imageMobile: '/assets/images/hero/computer_repair_mobile.jpg', cta: 'Repair My PC', link: '/services', align: 'left', order: 3 },
    ...
    { id: 'cctv_installation', title: 'CCTV Installation', subtitle: 'HD cameras, DVR/NVR setup & remote monitoring for homes and offices', image: '/assets/images/hero/cctv_installation.jpg', imageMobile: '/assets/images/hero/cctv_installation_mobile.jpg', cta: 'Secure Your Space', link: '/services', align: 'left', order: 5 },
  ],
};
